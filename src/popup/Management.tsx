...
import { ApplicantForm } from "./components/management/forms/ApplicantForm";
import { AccountForm } from "./components/management/forms/AccountForm";
import { ApplicationForm } from "./components/management/forms/ApplicationForm";
import { WebfileForm } from "./components/management/forms/WebfileForm";
import { ApplicantsList } from "./components/management/ApplicantsList";
import {
  type RecordItem,
  type FormMode,
  type CollectionName,
  getCollectionFromMode,
} from "./components/management/management.types";
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-[var(--app-bg)]">
      ...
      <header className="sticky top-0 z-10 border-b border-[var(--app-border)] bg-[var(--app-surface)]">
        <div className="flex h-14 items-center justify-between px-4">
          <div>
            <p className="text-sm font-bold">Management Panel</p>

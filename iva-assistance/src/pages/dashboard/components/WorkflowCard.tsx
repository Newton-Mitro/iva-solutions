...
function ManualNotice({ children }: { children: React.ReactNode }) {
  return (
    <div className="ivac-warning-bg ivac-warning mt-3 flex items-start gap-2 rounded-xl border border-current/10 p-2.5">
      <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-current/10">
        <InfoIcon />
      </div>

      <div className="min-w-0">
        <p className="text-[9px] font-bold">Manual action required</p>

        <p className="mt-0.5 text-[8px] leading-relaxed opacity-80">
          {children}
        </p>
      </div>
    </div>
...
function InfoIcon() {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-7-3a1 1 0 1 0-2 0v.01a1 1 0 0 0 2 0V7Zm-2 3a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2H10v3h1a1 1 0 1 1 0 2H9a1 1 0 1 1 0-2h1v-3Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
function ReadOnlyField({ label, value }: { label: string; value: string }) {
  return (
    <div className="min-w-0">
      <p className="mb-1 text-[8px] font-bold uppercase tracking-wide ivac-text-muted">
        {label}
      </p>

      <div className="ivac-input flex min-h-8 items-center truncate px-2.5 text-[9px] font-medium">
        {value}
      </div>
    </div>
  );
